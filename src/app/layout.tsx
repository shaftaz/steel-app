...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "steel weight formula all sections",
    "steel weight calculation guide",
    "weight of steel per metre",
    "steel density 7850",
    "d square by 162 formula explained",
    "steel weight constant 0.00785",
    "unit weight of steel",
    "steel weight per cubic metre",
    "steel scrap grades",
    "HMS 1 vs HMS 2",
    "ISRI scrap codes",
    "shredded scrap steel",
    "steel scrap classification",
    "ferrous scrap types",
    "scrap yield steelmaking",
    "scrap density",
    "heavy melting steel",
    "scrap to steel production cost",
    "steel melting cost calculator",
    "induction furnace scrap yield",
    "EAF scrap melting cost",
    "hollow vs solid shaft",
    "hollow section stronger than solid",
    "polar moment of inertia hollow shaft",
    "torsional strength hollow shaft",
    "second moment of area hollow section",
    "structural efficiency hollow steel",
    "BIS certification steel imports India",
    "steel QCO 2024",
    "BIS mandatory steel",
    "IS 2062 BIS certification",
    "steel import standards India 2026",
    "quality control order steel",
    "BIS license foreign manufacturers",
    "steel import monitoring system SIMS",
    "anti-dumping duty steel India 2026",
    "DGTR steel anti-dumping",
    "anti-dumping duty stainless steel India",
    "anti-dumping seamless tubes China India",
    "trade remedies steel India",
    "india steel scrap consumption FY26",
    "steel scrap deficit india",
    "DRI India steelmaking",
    "india scrap vs EU US",
    "vehicle scrappage policy steel",
    "india steel decarbonisation",
    "induction furnace scrap demand",
  ],
