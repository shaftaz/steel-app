      ...
      <div className="max-w-[1400px] mx-auto px-3 sm:px-4 py-2.5 flex items-center gap-4">
        ...
        <nav className="hidden md:flex items-center gap-1 flex-1">
          <div ref={dropdownRef} className="relative">
            ...
            {calcOpen && (
              <div className="absolute top-full left-0 mt-1 bg-[rgba(7,14,27,0.97)] backdrop-blur-xl border border-white/10 rounded-lg shadow-2xl p-4 min-w-[780px] grid grid-cols-4 gap-x-5 gap-y-4 z-50">
                ...
                <div className="col-span-4 border-t border-white/[0.06] pt-2 mt-1">
